...
var _elm_community$random_extra$Random_Int$intLessThan = function (value) {
	return A2(_elm_lang$core$Random$int, _elm_lang$core$Random$minInt, value - 1);
};
var _elm_community$random_extra$Random_Int$intGreaterThan = function (value) {
	return A2(_elm_lang$core$Random$int, value + 1, _elm_lang$core$Random$maxInt);
};
var _elm_community$random_extra$Random_Int$negativeInt = A2(_elm_lang$core$Random$int, _elm_lang$core$Random$minInt, -1);
var _elm_community$random_extra$Random_Int$positiveInt = A2(_elm_lang$core$Random$int, 1, _elm_lang$core$Random$maxInt);
var _elm_community$random_extra$Random_Int$anyInt = A2(_elm_lang$core$Random$int, _elm_lang$core$Random$minInt, _elm_lang$core$Random$maxInt);
...
var _user$project$Letterfall$svgletter = F2(
	function (i, letter) {
		var xpos = _elm_lang$core$Basics$toString(i * 32);
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$svg$Svg_Attributes$fontSize('55'),
					_elm_lang$svg$Svg_Attributes$fill('blue')
				]),
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$svg$Svg$text(letter)
				]));
	});
var _user$project$Letterfall$svglettersD3 = function (letters) {
	return A2(_elm_lang$core$List$indexedMap, _user$project$Letterfall$svgletter, letters);
};
var _user$project$Letterfall$svgletters = function (letters) {
	return A2(_elm_lang$core$List$indexedMap, _user$project$Letterfall$svgletter, letters);
};
var _user$project$Letterfall$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _user$project$Letterfall$alphabet = A2(_elm_lang$core$String$split, '', 'abcdefghijklmnopqrstuvwxyz');
var _user$project$Letterfall$d3Update = _elm_lang$core$Native_Platform.outgoingPort(
	'd3Update',
	function (v) {
...
var _user$project$Letterfall$Model = function (a) {
	return {letters: a};
};
var _user$project$Letterfall$init = {
	ctor: '_Tuple2',
	_0: _user$project$Letterfall$Model(_user$project$Letterfall$alphabet),
	_1: _user$project$Letterfall$d3Update(_user$project$Letterfall$alphabet)
};
var _user$project$Letterfall$ReplaceCards = function (a) {
	return {ctor: 'ReplaceCards', _0: a};
};
var _user$project$Letterfall$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'Shuffle') {
			return {
				...
				_1: A2(
					_elm_lang$core$Random$generate,
					_user$project$Letterfall$ReplaceCards,
					A2(
						_elm_lang$core$Random$pair,
						A2(_elm_lang$core$Random$int, 1, 25),
						_elm_community$random_extra$Random_Array$shuffle(
							_elm_lang$core$Array$fromList(_user$project$Letterfall$alphabet))))
			};
		} else {
			var newalpha = _elm_lang$core$Array$toList(
				A3(_elm_lang$core$Array$slice, 0, _p0._0._0, _p0._0._1));
			return {
				ctor: '_Tuple2',
				_0: _user$project$Letterfall$Model(newalpha),
				_1: _user$project$Letterfall$d3Update(newalpha)
			};
		}
	});
var _user$project$Letterfall$Shuffle = {ctor: 'Shuffle'};
var _user$project$Letterfall$view = function (model) {
	return A2(
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Basics$toString(model.letters))
					])),
				A2(
				_elm_lang$svg$Svg$svg,
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$svg$Svg_Attributes$width('960'),
						_elm_lang$svg$Svg_Attributes$height('120'),
						_elm_lang$svg$Svg_Attributes$viewBox('0 0 960 120')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$svg$Svg_Attributes$class('letters'),
								_elm_lang$svg$Svg_Attributes$transform('translate(32,60)')
							]),
						_elm_lang$core$Native_List.fromArray(
							[]))
					])),
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(_user$project$Letterfall$Shuffle)
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$svg$Svg$text('Roll')
					]))
			]));
};
var _user$project$Letterfall$main = {
	main: _elm_lang$html$Html_App$program(
		{init: _user$project$Letterfall$init, view: _user$project$Letterfall$view, update: _user$project$Letterfall$update, subscriptions: _user$project$Letterfall$subscriptions})
};

var Elm = {};
Elm['Letterfall'] = Elm['Letterfall'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Letterfall'], 'Letterfall', typeof _user$project$Letterfall$main === 'undefined' ? null : _user$project$Letterfall$main);
